...
<body>
    ...
    <div class="contenido_formulario">
        ...
        <form action="login_be.php" method="POST" class="formulario-registro">

        <div class="grupo-input">
            <label for="usuario_login">Usuario</label>
            <input type="text" id="usuario_login" name="correo" placeholder="Ingresa tu usuario" required class="input-moderno">
        </div>
        ...
        <button type="submit" name="iniciar sesion" class="boton-moderno">inicio</button>
        </form>

        <div class="ayuda-login" style="margin-top: 20px; text-align: center; font-size: 0.9rem;">
            <p style="margin-bottom: 8px;">
                <a href="recuperar.php" style="color: #001a33; text-decoration: underline;">¿Olvidaste tu contraseña?</a>
            </p>
            <p>
                ¿No tienes una cuenta? 
                <a href="registro.php" style="color: #D97C27; font-weight: bold;">Regístrate aquí</a>
            </p>
        </div>
    </div>
