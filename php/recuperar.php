...
<body>
    ...
    <form action="enviar_enlace.php" method="POST" class="formulario-registro">
        <p style="font-size: 0.85rem; color: #555; text-align: center;">
            Introduce tu correo y te enviaremos los pasos para restablecer tu contraseña.
        </p>
        <div class="grupo-input">
            <label>Correo Electrónico</label>
            <input type="email" name="email" class="input-moderno" required>
        </div>
        <button type="submit" class="boton-moderno">Enviar Enlace</button>
        <a href="login.php" style="margin-top:15px; font-size:0.8rem; color:#666;">Volver al Inicio</a>
    </form>
</div>
